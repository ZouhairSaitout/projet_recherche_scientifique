...
| --- | --- | --- |
| Report | `rapport/` | Yes |
| Slides and talk scripts | `slides/, script/` | Yes |
...
Report it privately by email to [romainben31@gmail.com](mailto:romainben31@gmail.com), or through GitHub's private vulnerability reporting if the owner of the repository has enabled it: [report a vulnerability](https://github.com/ZouhairSaitout/projet_recherche_scientifique/security/advisories/new).
...
* the LaTeX sources of the report and the bibliography;
